...
export default function GameDetail() {
  ...
  async function handleEditSubmit(e: React.FormEvent) {
    ...
    updateMutation.mutate({
      ...
      igdbId: editForm.igdbId ? Number.parseInt(editForm.igdbId) : null,
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        type="button"
                        onClick={() => coverFileReference.current?.click()}
                        className="text-xs text-accent hover:underline"
                      >
                        Upload
                      </button>
                      <input
                        ref={coverFileReference}
                        type="file"
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        type="button"
                        onClick={() => heroFileReference.current?.click()}
                        className="text-xs text-accent hover:underline"
                      >
                        Upload
                      </button>
                      <input
                        ref={heroFileReference}
                        type="file"
                        accept="image/jpeg,image/png,image/webp,image/gif"
                        className="hidden"
                        onChange={(e) => {
              ...
              <>
                ...
                {displayGame.summary && (
                  <div className="mb-8">
                    ...
                    <p className="text-text-secondary leading-relaxed">{displayGame.summary}</p>
                  </div>
                )}
