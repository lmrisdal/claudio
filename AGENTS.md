...
```yaml
BLOCKS:
  [SEL-01, SEL-02, SEL-03, CTX-01?, CTX-02?, OPT-01, OPT-02, OPT-03, OPT-04, OPT-05, REP-01, REP-02]
QUALITY_GATE:
...
MAPPING: A2 (systems) → "Integration" category
...
PREREQ: [
  ...
  ] # META composes from the block registry and domain packets
```
...
```yaml
TEMPLATE: 1. Why {symptom}? → Because {cause_1} [file:line]
...
_20 curated from 39 original (arXiv:2402.03620) + TMK structured scaffolds_
